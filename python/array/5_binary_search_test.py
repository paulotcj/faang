import unittest
import time
bin_search = __import__("4_binary_search")
BinarySearch = bin_search.BinarySearch
#----------------------------------
bs = BinarySearch()
#----------------------------------
...
class TestBinarySearch(unittest.TestCase):
    ...
    def test_execution_time_for_item_at_the_beginning(self):
        ...
        ######################
        ##
        ## We cant make the assumption below. In my computer the time for most runs was:
        ##      --- Linear Search 0.000000 seconds ---
        ##      --- Binary Search 0.000001 seconds ---
        ##
        ## But sometimes I got
        ##
        ##      --- Linear Search 0.000001 seconds ---
        ##      --- Binary Search 0.000001 seconds ---        
        ##
        ######################
